...
public class ActivistHomeActivity extends AppCompatActivity implements SelectListener {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    // adapter
                    adapterPosts = new AdapterPosts(ActivistHomeActivity.this, postList, ActivistHomeActivity.this);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                // in case of error
                Toast.makeText(ActivistHomeActivity.this, "" + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
...
/*
        ...
        Toast.makeText(ActivistHomeActivity.this, "" + modelPost.getpTitle(), Toast.LENGTH_SHORT).show();
  ...
  /*private void openHomePage() {
    ...
    private void signOut() {
        ...
        FragmentHelper.navigateToLoginFragment(this);
    }
}
